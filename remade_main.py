...
def broadcast_user_difference():
    ...
    print("Data:")
    print("\n".join([f"{name}, {int(time()) - members[name]['last ping']}" for name in visible_users]))
    print({'amount': len(members.keys()), 'names': [user for user in members]})
